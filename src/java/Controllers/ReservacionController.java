...
import Models.ReservacionFacade;
...
public class ReservacionController implements Serializable {
    ...
    @EJB
    private Models.ReservacionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("ReservacionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("ReservacionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("ReservacionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
