...
import Models.TipoproductoFacade;
...
public class TipoproductoController implements Serializable {
    ...
    @EJB
    private Models.TipoproductoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("TipoproductoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("TipoproductoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("TipoproductoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class TipoproductoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tipoproducto) {
                ...
                return getStringKey(o.getIdTproducto());
            } else {
