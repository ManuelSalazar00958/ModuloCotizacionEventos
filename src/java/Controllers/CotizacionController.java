...
import Models.CotizacionFacade;
...
public class CotizacionController implements Serializable {
    ...
    @EJB
    private Models.CotizacionFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("CotizacionCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("CotizacionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("CotizacionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
